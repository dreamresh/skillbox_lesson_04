...
cub_Konstantin = int(input('Кубик Кости: '))
cub_boss = int(input('Кубик владельца: '))
if cub_boss > cub_Konstantin:
    cub_end = cub_boss + cub_Konstantin
    print('Сумма очков:', cub_end, '\nВладелец платит.')
else:
    cub_end = cub_Konstantin - cub_boss
    print('Разность очков:', cub_end, '\nКостя платит.')
print('Игра окончена.')